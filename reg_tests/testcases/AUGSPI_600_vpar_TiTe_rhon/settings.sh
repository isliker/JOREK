# --- General settings
jorekmodel="600"
options="with_vpar=.true. with_TiTe=.true. with_neutrals=.true. with_impurities=.false. with_refluid=.false."
description="Deuterium SPI driven 2/1 mode in AUG with model600, including vpar, rhon, TiTe"
mpitasks=2
