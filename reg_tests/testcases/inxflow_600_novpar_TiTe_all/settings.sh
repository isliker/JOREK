# --- General settings
jorekmodel="600"
options="with_vpar=.false. with_TiTe=.true. with_neutrals=.false. with_impurities=.false. with_refluid=.false."
description="Ballooning mode, simple X-point plasma, model$jorekmodel, two temperature, vpar, n_tor=3 + FFT, many terms switched on."
mpitasks=2
...
function initial_run () {
  ...
  ${codedir}/util/setinput.sh input nstep_n=150 tstep_n=1.d1 restart=.t.             || exit 1
