# --- General settings
jorekmodel="303"
description="Fixed boundary AUG equilibrium, model$jorekmodel, n_tor=1."
mpitasks=1
binaries="jorek_model${jorekmodel}_1"
binaries_initial=""
requiredfiles="input Dprofile7.dat rho_fitted.dat t_fitted.dat ffp_fitted.dat Omega_tor_fitted_3.dat Zkprofile7.dat"
extra_remote_files="Dprofile7.dat rho_fitted.dat t_fitted.dat ffp_fitted.dat Omega_tor_fitted_3.dat Zkprofile7.dat"
...
function compare_results () {
  compare_results_generic 1.e-4                                                      || exit 1
}
