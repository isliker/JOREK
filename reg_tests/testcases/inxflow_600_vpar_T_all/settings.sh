...
description="Ballooning mode, simple X-point plasma, model$jorekmodel, single temperature, n_tor=3 + FFT, many terms switched on."
mpitasks=2
...
function initial_run () {
  ...
  ${codedir}/util/setinput.sh input nstep_n=300 tstep_n=1.d1 restart=.t.             || exit 1
