# --- General settings
jorekmodel="199"
description="Duplicate of freebound_equil_limiter_starwallcoils with 2 MPI tasks. Free boundary equilibrium for limiter plasma using coils directly in STARWALL (JOREK-STARWALL)."
mpitasks=2
