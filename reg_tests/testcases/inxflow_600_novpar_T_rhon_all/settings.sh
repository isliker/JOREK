# --- General settings
jorekmodel="600"
options="with_vpar=.false. with_TiTe=.false. with_neutrals=.true. with_impurities=.false. with_refluid=.false."
description="Ballooning mode, simple X-point plasma, model$jorekmodel, single temperature, no vpar, rhon, n_tor=3 + FFT, many terms switched on."
mpitasks=2
