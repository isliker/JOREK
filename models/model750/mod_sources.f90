...
interface sources
  module procedure sources_TiTe, sources_T
...
subroutine sources_TiTe(xpoint2, xcase2, Z, Z_xpoint, psi, psi_axis, psi_bnd, particle_source, heat_source_i, heat_source_e)
